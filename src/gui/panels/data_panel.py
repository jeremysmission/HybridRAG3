...
def _bind_datapanel_methods():
    DataPanel._load_resume_state = _load_resume_state
    DataPanel._save_resume_state = _save_resume_state
    DataPanel._clear_resume_state = _clear_resume_state
    DataPanel._maybe_resume_transfer = _maybe_resume_transfer
    DataPanel._build_source_path_section = _build_source_path_section
    DataPanel._on_change_source = _on_change_source
    DataPanel._build_browser_section = _build_browser_section
    DataPanel._on_browse = _on_browse
    DataPanel._build_preview_section = _build_preview_section
    DataPanel._on_preview = _on_preview
    DataPanel._persist_transfer_source_path = _persist_transfer_source_path
    DataPanel._scan_preview = _scan_preview
    DataPanel._set_preview_text = _set_preview_text
    DataPanel._build_transfer_section = _build_transfer_section
    DataPanel._on_start_transfer = _on_start_transfer
    DataPanel._apply_estimate_value = _apply_estimate_value
    DataPanel._on_apply_estimate = _on_apply_estimate
    DataPanel._start_transfer = _start_transfer
    DataPanel._run_transfer = _run_transfer
    DataPanel._on_stop_transfer = _on_stop_transfer
    DataPanel._ensure_transfer_cleanup = _ensure_transfer_cleanup
    DataPanel._poll_stats = _poll_stats
    DataPanel._on_transfer_done = _on_transfer_done
    DataPanel._on_transfer_error = _on_transfer_error
    DataPanel._get_last_manifest_reason = _get_last_manifest_reason
    DataPanel._read_total_copied_bytes_from_manifest = _read_total_copied_bytes_from_manifest
    DataPanel._build_post_transfer_section = _build_post_transfer_section
    DataPanel._goto_index = _goto_index
    DataPanel.apply_theme = apply_theme

_bind_datapanel_methods()
