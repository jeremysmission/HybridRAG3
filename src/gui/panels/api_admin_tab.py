...
# ---------------------------------------------------------------------------
# ApiAdminTab runtime methods (extracted to keep class code under 500 lines)
# ---------------------------------------------------------------------------
...
def _bind_api_admin_tab_runtime_methods() -> None:
    """Attach extracted ApiAdminTab methods at import time."""
    ApiAdminTab._build_dev_hidden_notice = _api_admintab__build_dev_hidden_notice
    ApiAdminTab._build_credentials_section = _api_admintab__build_credentials_section
    ApiAdminTab._toggle_key_visibility = _api_admintab__toggle_key_visibility
    ApiAdminTab._refresh_credential_status = _api_admintab__refresh_credential_status
    ApiAdminTab._refresh_network_policy_label = _api_admintab__refresh_network_policy_label
    ApiAdminTab._on_save_credentials = _api_admintab__on_save_credentials
    ApiAdminTab._on_test_connection = _api_admintab__on_test_connection
    ApiAdminTab._do_test_connection = _api_admintab__do_test_connection
    ApiAdminTab._probe_online_endpoint = _api_admintab__probe_online_endpoint
    ApiAdminTab._probe_online_chat = _api_admintab__probe_online_chat
    ApiAdminTab._deployments_to_models = _api_admintab__deployments_to_models
    ApiAdminTab._test_done = _api_admintab__test_done
    ApiAdminTab._test_failed = _api_admintab__test_failed
    ApiAdminTab._test_warn = _api_admintab__test_warn
    ApiAdminTab._on_clear_credentials = _api_admintab__on_clear_credentials
    ...
    ApiAdminTab._build_defaults_section = _api_admintab__build_defaults_section
    ApiAdminTab._on_save_defaults = _api_admintab__on_save_defaults
    ApiAdminTab._on_restore_defaults = _api_admintab__on_restore_defaults
    ApiAdminTab._refresh_defaults_status = _api_admintab__refresh_defaults_status
    ApiAdminTab.apply_theme = _api_admintab_apply_theme

_bind_api_admin_tab_runtime_methods()
