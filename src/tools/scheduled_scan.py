...
# Purpose: Implements the scheduled scan part of the application runtime.
...
#      Program: D:\HybridRAG3\.venv\Scripts\python.exe
#      Arguments: D:\HybridRAG3\src\tools\scheduled_scan.py
#      Start in: D:\HybridRAG3
