...
$searchPaths = @(
    ...
    "D:\HybridRAG2\model_cache",
    "D:\HybridRAG2\.model_cache",
    "D:\HybridRAG2\.hf_cache",
    "D:\HybridRAG2\.torch_cache",
    "D:\HybridRAG2\src\core\model_cache",
...
Write-Host "    - D:\HybridRAG2\model_cache (or wherever your active project loads from)" -ForegroundColor White
...
Write-Host '    Select-String "model_cache\|cache_dir\|cache_folder" D:\HybridRAG2\src\core\embedder.py' -ForegroundColor Gray
Write-Host ""
