...
# Purpose: Implements the guard config part of the application runtime.
...
class HallucinationGuardConfig:
    ...
    For air-gapped deployment, copy .model_cache/ to the target machine.
    ...
    # For air-gapped work: copy the cache folder from a connected machine.
