...
|-------|---------------|-----|
| PowerShell (start_hybridrag.ps1) | Outbound network calls | Session environment variables |
| Python (embedder.py) | Non-Ollama embedding calls | os.environ enforcement before import |
