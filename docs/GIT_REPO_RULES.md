...
NEVER INCLUDES:
- Any mention of: defense, contractor, corporate, classified, NGC, company names
...
- Personal paths (D:\RAG Source Data, D:\RAG Indexed Data)
- API keys or credentials
- Session transcripts, primers, handover docs, or chat history
- Work-specific configuration
- NIST/DoD/military standard references
...
### Defense/Corporate
- defense, contractor, classified, restricted, corporate
- Any company names or acronyms (NGC, Northrop, Grumman)
- Any project codenames
- Any employee names (Jeremy, randaje)
- Any internal URLs or endpoints
- NIST, DoD, CJCSM, ITAR, CUI, CMMC, clearance
...
- "defense contractor environment" -> "enterprise environment"
- "restricted network" -> "air-gapped network"
...
Select-String -Path (git diff --cached --name-only) -Pattern "defense|contractor|classified|NGC|Claude|Anthropic" -SimpleMatch
```
