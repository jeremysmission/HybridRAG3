...
Extract to your project folder (e.g., D:\HybridRAG3).
...
If you're on an air-gapped machine, copy the .model_cache/ folder from a
connected machine.
...
The embedding model downloads automatically (~87MB). If on an air-gapped
