# HybridRAG3 Study Guide -- For Jeremy
...
- **Online (API):** A large cloud AI model (GPT-4, Claude) runs on
...
```
YOUR DOCUMENTS FOLDER (e.g., D:\RAG Source Data)
        |
        v
...
4. **Injection defense (Rule 5):** If someone plants false information
