...
|---|---|---|
| Software Engineering | sonnet-4 | gpt-4.1 |
| Engineering / STEM | sonnet-4 | gpt-4o |
| Systems Admin | sonnet-4 | gpt-4o |
| Drafting / CAD | sonnet-4 | gpt-4o |
| Logistics | gpt-4o | gpt-4.1 |
| Program Management | gpt-4o-mini | gpt-4.1-mini |
| Field Engineer | sonnet-4 | gpt-4o |
| Cybersecurity | sonnet-4 | gpt-4o |
| General AI | gpt-4o | sonnet-4 |
...
|---|---|---|
| **OFFLINE** | localhost only (127.0.0.1, ::1, 0.0.0.0) | Default, air-gapped |
...
### Banned Model Families (NDAA / ITAR)
...
| **Meta / Llama** | Llama 2, Llama 3, Code Llama | Acceptable Use Policy prohibits military use (ITAR) | Excluded from auto-selection |
