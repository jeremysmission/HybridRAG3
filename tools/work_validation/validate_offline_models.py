...
# Purpose: Automates the validate offline models operational workflow for developers or operators.
...
WORK_MODELS = {
    "phi4-mini":           {"size_gb": 2.3, "note": "Fallback model for low-VRAM systems (MIT, Microsoft/USA)"},
    "mistral:7b":          {"size_gb": 4.1, "note": "General fallback model (Apache 2.0, Mistral/France)"},
    "phi4:14b-q4_K_M":    {"size_gb": 9.1, "note": "Primary model for 8/9 work profiles (MIT, Microsoft/USA)"},
    "gemma3:4b":           {"size_gb": 3.3, "note": "Small summarization fallback (Apache 2.0, Google/USA)"},
    "mistral-nemo:12b":    {"size_gb": 7.1, "note": "Primary for general profile, alt for work profiles (Apache 2.0, Mistral+NVIDIA, 128K ctx)"},
}
