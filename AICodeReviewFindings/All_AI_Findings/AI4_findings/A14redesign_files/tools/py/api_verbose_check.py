__test__ = False  # utility script; not a pytest test
...
if is_azure:
    if "/chat/completions" in endpoint:
        ...
        if "api-version" not in base:
            final_url += "?api-version=" + os.environ.get("AZURE_OPENAI_API_VERSION", "2024-02-02")
    elif "/deployments/" in endpoint:
        v = os.environ.get("AZURE_OPENAI_API_VERSION", "2024-02-02")
